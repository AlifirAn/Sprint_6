...
class OrderPageLocators:
    ...
    METRO_STATION_CHERKIZOVSKAYA = (By.XPATH, "//div[text()='Черкизовская']") #здесь локатор выбора метро
    ...
    DATE_TODAY = (By.CSS_SELECTOR, ".react-datepicker__day--today") #здесь локатор выбора даты
    RENTAL_PERIOD_FIELD = (By.CSS_SELECTOR, '.Dropdown-arrow')
    RENTAL_PERIOD_DAY = (By.XPATH, "//div[text()='сутки']") #здесь локатор выбора периода
    COLOR = (By.ID, "black") #здесь  локатор цвета самоката
